...
export const adminUserAPI = {
  ...
  getAllUsers: async (): Promise<User[]> => {
    const response = await adminAPI.get(API.management.admin.users.list);
    return response.data;
  },

  // Get users by role
  getUsersByRole: async (role: string): Promise<User[]> => {
    const response = await adminAPI.get(API.management.admin.users.getByRole(role));
    return response.data;
  },

  // Get user by ID
  getUserById: async (id: number): Promise<User> => {
    const response = await adminAPI.get(API.management.admin.users.getById(id));
    return response.data;
  },

  // Update user
  updateUser: async (id: number, userData: Partial<User>): Promise<User> => {
    const response = await adminAPI.put(API.management.admin.users.update(id), userData);
    return response.data;
  },
  ...
  getVerifiedUsers: async (): Promise<User[]> => {
    const response = await adminAPI.get(API.management.admin.users.verified);
    return response.data;
  },

  // Get unverified users
  getUnverifiedUsers: async (): Promise<User[]> => {
    const response = await adminAPI.get(API.management.admin.users.unverified);
    return response.data;
  },

  // Get active users
  getActiveUsers: async (): Promise<User[]> => {
    const response = await adminAPI.get(API.management.admin.users.active);
    return response.data;
  },

  // Get inactive users
  getInactiveUsers: async (): Promise<User[]> => {
    const response = await adminAPI.get(API.management.admin.users.inactive);
    return response.data;
  },
};
...
export const adminVendorAPI = {
  ...
  getAllVendors: async (): Promise<User[]> => {
    const response = await adminAPI.get(API.management.admin.vendors.list);
    return response.data;
  },

  // Update vendor type
  updateVendorType: async (userId: number, vendorType: string): Promise<User> => {
    const response = await adminAPI.put(API.management.admin.vendors.updateType(userId), null, {
      params: { vendorType }
    });
    return response.data;
  },
...
export const adminProductAPI = {
  ...
  getAllProducts: async (page = 0, size = 12, category?: string, search?: string): Promise<{ content: Product[], totalElements: number }> => {
    const response = await adminAPI.get(API.management.admin.products.list, {
  ...
  getProductById: async (id: number): Promise<Product> => {
    const response = await adminAPI.get(API.management.admin.products.getById(id));
    return response.data;
  },
