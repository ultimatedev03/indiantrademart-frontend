...
export const authAPI = {
  ...
  // Buyer login
  buyerLogin: async (credentials: LoginCredentials): Promise<JwtResponse> => {
    const response = await api.post('/api/auth/buyer/login', credentials);
    return response.data;
  },

  // Vendor login
  vendorLogin: async (credentials: LoginCredentials): Promise<JwtResponse> => {
    const response = await api.post('/api/auth/vendor/login', credentials);
    return response.data;
  },

  // Buyer registration
  buyerRegister: async (userData: RegisterData): Promise<JwtResponse> => {
    const response = await api.post('/api/auth/buyer/register', userData);
    return response.data;
  },
  ...
  resetPassword: async (data: ResetPasswordRequest): Promise<{ message: string }> => {
    const response = await api.post('/api/auth/verify-forgot-password-otp', data);
    return response.data;
  },
